...
describe('UserRepository test', () => {
  it('should throw error when invoke unimplemented method', async () => {
    ...
    await expect(userRepository.editProfile()).rejects.toThrowError('UserRepository is abstract class');
    await expect(userRepository.getProfile()).rejects.toThrowError('UserRepository is abstract class');
  });
});
